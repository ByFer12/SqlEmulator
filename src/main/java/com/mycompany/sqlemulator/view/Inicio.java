...
public class Inicio extends javax.swing.JFrame {
        ...
        arbolDirectorio.addTreeSelectionListener(new TreeSelectionListener() {
            ...
            public void valueChanged(TreeSelectionEvent tse) {
                ...
                if (archivo.contains(".")) {
                    ...
                    leerArchivo(ruta + "/" + tabbed1.getTitleAt(tabbed1.getSelectedIndex()));
                    int num = tabbed1.getTabCount();
    ...
    private void initComponents() {
        ...
        openFile.setIcon(new javax.swing.ImageIcon("/home/tuxrex/NetBeansProjects/Web/SQLemulator/src/main/java/com/mycompany/sqlemulator/Icons/file.png")); // NOI18N
    ...
    private void openFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_openFileActionPerformed
        ...
        abrirDirectorio.setFileSelectionMode(JFileChooser.DIRECTORIES_ONLY);
